...
public class SonyPSNIdentityProvider extends BaseIdentityProvider<SonyPSNApplicationConfiguration> implements Buildable<SonyPSNIdentityProvider>, SupportsPostBindings {
  ...
  public boolean equals(Object paramObject) {
    if (this == paramObject)
      return true; 
    if (!(paramObject instanceof SonyPSNIdentityProvider))
      return false; 
    if (!super.equals(paramObject))
      return false; 
    SonyPSNIdentityProvider sonyPSNIdentityProvider = (SonyPSNIdentityProvider)paramObject;
    return (Objects.equals(this.buttonText, sonyPSNIdentityProvider.buttonText) && 
      Objects.equals(this.client_id, sonyPSNIdentityProvider.client_id) && 
      Objects.equals(this.client_secret, sonyPSNIdentityProvider.client_secret) && 
      Objects.equals(this.scope, sonyPSNIdentityProvider.scope));
  }
