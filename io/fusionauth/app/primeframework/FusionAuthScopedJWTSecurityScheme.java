...
public class FusionAuthScopedJWTSecurityScheme extends JWTSecurityScheme {
  @Inject
  public FusionAuthScopedJWTSecurityScheme(ActionInvocationStore paramActionInvocationStore, JWTSecurityContext paramJWTSecurityContext, @Named("ScopedJWTValidator") JWTConstraintsValidator paramJWTConstraintsValidator, HTTPRequest paramHTTPRequest) {
