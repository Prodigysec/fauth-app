...
public class ManageScopesAction extends BaseFormAction {
  @FTLVariable
  public boolean isLicensedForCustomScopes;
  
  @Inject
  public ManageScopesAction(FrontEndSupport paramFrontEndSupport, ProxyInfoSupplier paramProxyInfoSupplier, Cache<UUID, CachedTheme> paramCache) {
