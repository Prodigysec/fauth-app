package io.fusionauth.app.action.ajax.tenant.key;
...
public class SearchAction extends BaseAJAXAction {
  ...
  private boolean isValidForType(Key paramKey, TenantKeyType paramTenantKeyType) {
    switch (paramTenantKeyType) {
      default:
    ...
    return 
      ...
      KeyValidator.validForIdTokenVerification(paramKey);
  }
}
