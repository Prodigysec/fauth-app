...
public class ImportAction extends BaseAPIAction {
  ...
  @Inject
  public ImportAction(FrontEndSupport paramFrontEndSupport, KeyService paramKeyService) {
  ...
  public void validate() {
    ...
    this.frontEndSupport.transfer(this.keyService.validateImport(this.request.key));
  }
}
