...
public class PortablePHPSHA512PasswordEncryptor extends BasePortablePHPPasswordEncryptor {
  ...
  public String encrypt(String paramString1, String paramString2, int paramInt) {
    ...
    return base64Encode(arrayOfByte2, arrayOfByte2.length).substring(0, 43);
  }
}
